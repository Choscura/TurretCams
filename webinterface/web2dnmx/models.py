...
from dxl.dxlchain import *


class connection(models.Model):
	"""
	A connection object is the software interface to the actuated ("motored") entity. 
	Basically, a connection is a "group of motors" to whom commands can be sent.
	"""
	def __init__(self):
		pass
