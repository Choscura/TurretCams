...
#
#
 class djangodxlchain(models.Model, dxl.DxlChain):
#     """
#        Commented out triple quotes indicate original documentation copied directly from class definition of dxl.DxlChain
...
#         conf=self.get_configuration()
         return json.dumps(conf,indent=4,sort_keys=False)
#
